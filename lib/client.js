    ...
    function WechatSection(props) {
      ...
      if (activeTab === "wecom") {
        channelPanel = [
          ...
          createElement.apply(null, [createElement("div", { style: cardStyle, key: "wecom-tpl" },
            createElement("div", { style: cardTitleStyle }, t("templates")))].concat(renderTemplateFields(wecomTpl, function (k, v) { setChannelTemplate("wecom", k, v); }))),
        ...
        channelPanel = [
          ...
          createElement.apply(null, [createElement("div", { style: cardStyle, key: "weixin-card" },
          ...
          )].concat(renderTemplateFields(weixinTpl, function (k, v) { setChannelTemplate("weixin", k, v); }))),
